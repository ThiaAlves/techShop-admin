        ...
        'InputFile' => [
            ...
            'files' => [
                [
                    'type' => 'css',
                    'asset' => true,
                    'location' => 'vendor/input-file/css/fileinput.min.css',
                ],
                [
                    'type' => 'js',
                    'asset' => true,
                    'location' => 'vendor/input-file/js/fileinput.min.js',
                ],
                [
                    'type' => 'js',
                    'asset' => true,
                    'location' => 'vendor/input-file/js/locales/pt-BR.js',
                ],
                [
                    'type' => 'js',
                    'asset' => true,
                    'location' => 'vendor/input-file/js/plugins/theme.min.js',
                ],
